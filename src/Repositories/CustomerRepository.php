...
class CustomerRepository
{
    ...
    public function create(Customer $customer)
    {
        $sql = "INSERT INTO Customers (
            order_id, customer_id, company, first_name, last_name, name,
            address1, address2, default_full_address,
            billing_address1, billing_address2, billing_full_address,
            shipping_address1, shipping_address2, shipping_full_address,
